...
var Service_1 = require("typedi/decorators/Service");
/**
...
var RoutingControllers = /** @class */ (function () {
     ...
     */
    RoutingControllers.prototype.registerServices = function (classes) {
        container_1.useContainer(Container_1.Container);
        classes.forEach(function (service) {
